...
def generate_launch_description():
    ...
    servos_launch_path = "/home/ubuntu/ros2_ws/src/mini_pupper_ros/mini_pupper_driver/launch/modified_servo_interface.py"
    
    lidar_launch_path = "/home/ubuntu/ros2_ws/src/mini_pupper_ros/mini_pupper_driver/launch/modified_lidar_ld06.py"
    ...
    # Wrap the launch descriptions in a GroupAction and apply the 'robotx' namespace
    return LaunchDescription([
        ...
        GroupAction(actions=[
            IncludeLaunchDescription(
                ...
                launch_arguments={'namespace': 'robotx'}.items()
            ),
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(lidar_launch_path),
                condition=IfCondition(has_lidar),
                launch_arguments={'lidar_port': lidar_port, 'namespace': 'robotx'}.items(),
            ),
            IncludeLaunchDescription(
