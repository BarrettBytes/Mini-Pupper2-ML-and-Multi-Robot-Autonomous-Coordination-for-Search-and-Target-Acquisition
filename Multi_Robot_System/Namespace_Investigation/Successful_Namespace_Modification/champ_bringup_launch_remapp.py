...
def generate_launch_description():
    ...
    # Declare all necessary arguments
    ...
    declare_close_loop_odom = DeclareLaunchArgument(
        "close_loop_odom", default_value="false", description="Close loop odom"
    )

    # Description node inclusion
    ...
    quadruped_controller_node = Node(
        ...
        remappings=[
            ...
            ("/robotx/cmd_vel/smooth", "/robotx/cmd_vel")
        ],
    )
