#### must name this ~/ros2_ws/install/champ_bringup/share/champ_bringup/launch/bringup_launch_remapp.py
#### can also name anything as long as in this folder
#### but if changed the name from suggested then must modify ~/ros2_ws/src/mini_pupper_ros/mini_pupper_bringup/launch/bringup_basic_remap.launch.py
#### where it points to this file to the new name
#############
...
def generate_launch_description():
    ...
    quadruped_controller_node = Node(
        ...
        remappings=[
            ("/cmd_vel/smooth", "/robotx/cmd_vel"),
            ("/cmd_vel", "/robotx/cmd_vel")
            ],
    )
