...
##### This file must be named  ~/ros2_ws/src/mini_pupper_ros/mini_pupper_bringup/launch/bringup_basic_remap.launch.py
##### or something similar in the same folder (must be in that folder with the other bringup ################
...
def generate_launch_description():
    ...
    # Updated the path to point to the specific bringup_launch_remapp.py
    ...
    champ_bringup_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "gazebo": use_sim_time,
            "rviz": "False",  # set always false to launch RViz2 with custom .rviz file
