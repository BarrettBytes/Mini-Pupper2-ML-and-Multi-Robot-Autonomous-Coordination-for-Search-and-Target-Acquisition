...
def generate_launch_description():
    ...
    localisation_launch_path = PathJoinSubstitution(
        [this_package, 'launch', 'localise_launch.py']
    )
    nav2_launch_path = PathJoinSubstitution(
        [this_package, 'launch', 'nav_launch_multi.py']
    )
    rviz_config_file_path = PathJoinSubstitution([this_package, 'rviz', 'navigation.rviz'])

    # Launch Configuration Variables
    namespace = LaunchConfiguration('namespace')  # New: Robot-specific namespace
    ...
    namespace_launch_arg = DeclareLaunchArgument(
        name='namespace',
        default_value='robotx',  # Set default namespace as robotx, can be overridden
    ...
    return LaunchDescription([
        ...
        # # Include the nav2_bringup with namespace and parameters
        # IncludeLaunchDescription(
        #     PythonLaunchDescriptionSource(nav2_launch_path),
        #     launch_arguments={
        #         'namespace': namespace,  # Apply the namespace
        ...
        # Launch RViz2 in the specified namespace
        # Node(
        #     package='rviz2',
        #     executable='rviz2',
        #     namespace=namespace,  # Add namespace to RViz node
        #     name='rviz2',
        #     arguments=[
