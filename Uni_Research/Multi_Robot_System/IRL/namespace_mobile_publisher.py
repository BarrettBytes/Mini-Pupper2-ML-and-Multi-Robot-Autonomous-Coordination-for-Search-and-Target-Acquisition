...
def generate_launch_description():
    ...
    # Declare the 'namespace' launch argument with a default value
    ...
    # Define the mobilenet_node with remappings based on the namespace
    mobilenet_node = Node(
        package='depthai_examples',
        executable='mobilenet_node',
        name='mobilenet_node',
        namespace=LaunchConfiguration('namespace'),  # This is the key change to use the dynamic namespace
        output='screen',
        parameters=[
            {'tf_prefix': tf_prefix},
        ...
        remappings=[
            (
                ...
                PathJoinSubstitution([
                    ...
                    TextSubstitution(text='/color/mobilenet_detections')
                ])
            ),
            (
                '/color/image',
                PathJoinSubstitution([
                    TextSubstitution(text='/'),
                    LaunchConfiguration('namespace'),
                    TextSubstitution(text='/color/image')
                ])
            )
        ]
    )
