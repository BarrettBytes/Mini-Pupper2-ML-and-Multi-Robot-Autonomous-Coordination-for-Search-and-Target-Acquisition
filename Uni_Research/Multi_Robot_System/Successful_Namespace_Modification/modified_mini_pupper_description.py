...
# sudo nano /home/ubuntu/ros2_ws/src/mini_pupper_ros/mini_pupper_description/launch/modified_mini_pupper_description.py
...
def generate_launch_description():
    ...
    robot_state_publisher_node = Node(
        ...
        namespace="robotx",  # Adding namespace 'robotx'
        parameters=[
